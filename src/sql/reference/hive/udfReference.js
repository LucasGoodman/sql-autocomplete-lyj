...
exports.UDF_CATEGORIES = [
    { name: i18n_1["default"]('Aggregate'), isAggregate: true, functions: AGGREGATE_FUNCTIONS },
    { name: i18n_1["default"]('Analytic'), isAnalytic: true, functions: ANALYTIC_FUNCTIONS },
    { name: i18n_1["default"]('Collection'), functions: COLLECTION_FUNCTIONS },
    { name: i18n_1["default"]('Complex Type'), functions: COMPLEX_TYPE_CONSTRUCTS },
    { name: i18n_1["default"]('Conditional'), functions: CONDITIONAL_FUNCTIONS },
    { name: i18n_1["default"]('Date'), functions: DATE_FUNCTIONS },
    { name: i18n_1["default"]('Mathematical'), functions: MATHEMATICAL_FUNCTIONS },
    { name: i18n_1["default"]('Misc'), functions: MISC_FUNCTIONS },
    { name: i18n_1["default"]('String'), functions: STRING_FUNCTIONS },
    { name: i18n_1["default"]('Data Masking'), functions: DATA_MASKING_FUNCTIONS },
    { name: i18n_1["default"]('Table Generating'), functions: TABLE_GENERATING_FUNCTIONS },
    { name: i18n_1["default"]('Type Conversion'), functions: TYPE_CONVERSION_FUNCTIONS }
];
