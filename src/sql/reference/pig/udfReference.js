...
exports.UDF_CATEGORIES = [
    { name: i18n_1["default"]('Eval'), functions: EVAL_FUNCTIONS },
    { name: i18n_1["default"]('Relational Operators'), functions: RELATIONAL_OPERATORS },
    { name: i18n_1["default"]('Input and Output'), functions: INPUT_OUTPUT },
    { name: i18n_1["default"]('Debug'), functions: DEBUG },
    { name: i18n_1["default"]('HCatalog'), functions: HCATALOG },
    { name: i18n_1["default"]('Math'), functions: MATH_FUNCTIONS },
    { name: i18n_1["default"]('Tuple, Bag and Map'), functions: TUPLE_BAG_MAP },
    { name: i18n_1["default"]('String'), functions: STRING_FUNCTIONS },
    { name: i18n_1["default"]('Macros'), functions: MACROS },
    { name: i18n_1["default"]('HBase'), functions: HBASE },
    { name: i18n_1["default"]('Python UDF'), functions: PYTHON_UDF }
];
